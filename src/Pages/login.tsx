...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex font-sans bg-slate-50">
      ...
      <div className="hidden lg:flex flex-1 bg-linear-to-br from-indigo-600 via-violet-600 to-fuchsia-700 p-12 items-center justify-center relative overflow-hidden">
        {/* Glowing orbs */}
        <div className="absolute rounded-full blur-[72px] opacity-35 pointer-events-none w-80 h-80 bg-indigo-400 -top-16 -right-16" />
        <div className="absolute rounded-full blur-[72px] opacity-35 pointer-events-none w-64 h-64 bg-fuchsia-400 -bottom-10 -left-10" />

        <div className="relative z-10 max-w-md flex flex-col gap-5">
          {/* Logo */}
          <div className="w-[52px] h-[52px] rounded-xl bg-white/20 border border-white/30 flex items-center justify-center">
            <GraduationCap size={28} color="#fff" />
          </div>

          <p className="text-white/85 text-[13px] font-semibold tracking-widest uppercase m-0">
            EduPlatform
          </p>
          ...
          <p className="text-white/75 text-base leading-relaxed m-0 max-w-sm">
          ...
          {/* Floating cards */}
          <div className="flex items-center gap-3 bg-white/95 rounded-xl p-4 shadow-xl mt-2 max-w-[280px]">
      ...
      {/* ── Right login panel ── */}
      <div className="w-full lg:w-[460px] flex flex-col items-center justify-center p-6 bg-slate-50">
        <Card className="w-full max-w-md shadow-lg border-slate-200">
          <CardHeader className="text-center pb-4">
            <div className="w-[52px] h-[52px] rounded-xl bg-indigo-500/10 flex items-center justify-center mx-auto mb-3">
          ...
          <CardFooter className="flex flex-col gap-3 pt-0">
            <Button
              ...
              form="login-form"
              disabled={isLoading}
              className="w-full h-11 text-base font-semibold bg-linear-to-r from-indigo-600 to-violet-600 border-none flex items-center justify-center gap-2 cursor-pointer text-white hover:opacity-90 transition-opacity"
            >
              {isLoading ? (
                <>
